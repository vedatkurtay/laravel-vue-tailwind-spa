      ...
      <card :padding="false">
        <ul>
          <li v-for="tab in tabs" :key="tab.route">
            <router-link :to="{ name: tab.route }" class="px-6 py-4 flex items-center text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded" active-class="text-indigo-600 bg-indigo-50 hover:bg-indigo-50">
